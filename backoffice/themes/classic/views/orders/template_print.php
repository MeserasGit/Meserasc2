    ...
    <div class="modal-content">
      ...
      <DIV v-if="hasData" class="receipt-container m-autox pt-2">		  
	      ...
	      <div class="text-center mb-3">
		      ...
		      <p class="m-0"><?php echo t("Phone")?> : {{merchant.contact_phone}} /  <?php echo t("Email")?> : {{merchant.contact_phone}}</p>
	      </div>
	      ...
	      <div class="details mt-2 mb-2">	        	        	        
	        ...
	        <div class="row">
	         <div class="col"><?php echo t("Address")?> : {{order_info.delivery_address}}</div>	         
	        </div>	          
