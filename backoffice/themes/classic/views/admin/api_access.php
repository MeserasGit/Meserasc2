...
<div class="form-label-group">    
   <?php echo $form->textField($model,'payment_api_url',array(
     ...
     'disabled'=>true,
     'value'=>CommonUtility::getHomebaseUrl()."/payv1"
   )); ?>   
   <label for="AR_option_reservation_api_url">
    <?php echo t("Payment API URL")?>
   </label>
   <?php echo $form->error($model,'payment_api_url'); ?>
</div>

<div class="form-label-group">    
   <?php echo $form->textField($model,'reservation_api_url',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>t("Reservation API"),     
     'disabled'=>true,
     'value'=>CommonUtility::getHomebaseUrl()."/apibooking"
   )); ?>      
   <label for="AR_option_reservation_api_url">
    <?php echo t("Booking API URL")?>
   </label>
   <?php echo $form->error($model,'reservation_api_url'); ?>
</div>
