...
{	
	...
	public function rules()
	{
		 return array(
            ...
            short_description,percent_commision,commision_based,path,commision_type,role_access','safe'),   
            
            array('short_description','length','max'=>1000),
                        
            
            array('merchant_type,package_id,allowed_offline_payment,invoice_terms,invoice_terms2,commission_type,commission_value','safe'),
