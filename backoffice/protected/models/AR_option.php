...
{	
	...
	$points_registration,$points_review,$points_first_order,$points_booking;
	...
	$merchant_enabled_auto_accept_order,$driver_add_proof_photo,$driver_on_demand_availability;
