...
{	
	...
	{
		return array(
		  array('printer_name,printer_model', 
		  'required','message'=> t( Helper_field_required ) ),
		  		  
          //array("printer_name",'unique','message'=>t(Helper_field_unique) ),

		  array('printer_name', 'filter','filter'=>array($obj=new CHtmlPurifier(),'purify')), 		  
		  
		  array('merchant_id,device_uuid,paper_width,auto_print,date_created,ip_address,service_id,characteristics','safe'),		  

          array('printer_uuid','checkPrinterUUID'),

		  array('printer_user,printer_ukey,printer_sn,printer_key', 
		  'required','message'=> t( Helper_field_required ) ,'on'=>"feieyun_add" ),
