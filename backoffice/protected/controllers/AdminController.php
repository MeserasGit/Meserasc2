...
class AdminController extends CommonController
{
    ...
    public function actionlogin_sigup()
	{
		...
		'signup_resend_counter','signupnew_tpl','enabled_guest','backend_forgot_password_tpl'
		);
	...
	public function actionmerchant_registration()
	{
		...
		'merchant_plan_near_expired_tpl','merchant_allow_login_afterregistration'
		);
	...
	public function actionsite_others()
	{
		...
		$options = array('allow_return_home','image_resizing',
	 	   'runactions_method','runactions_enabled','menu_layout','enabled_copy_opening_hours','merchant_default_opening_hours_start','merchant_default_opening_hours_end',
		   'enabled_copy_payment_setting','copy_payment_list','runaction_test_tpl',
		   'menu_disabled_inline_addtocart','category_position','auto_accept_order_status','auto_accept_order_timer','auto_accept_order_enabled'
	    );
	...
	public function actionmobile_settings()
	{
		...
		$options = array('pwa_url','android_download_url','ios_download_url','enabled_auto_pwa_redirect',
		  'mobile_app_version_android','mobile_app_version_ios'
	    );
