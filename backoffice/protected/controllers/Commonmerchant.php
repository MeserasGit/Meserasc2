...
class Commonmerchant extends CController
{
	...
	public function initSettings()
	{
		Yii::app()->params['settings'] = OptionsTools::find(array(
			  ...
			  'enabled_language_bar','default_language','map_provider','google_geo_api_key','mapbox_access_token','multicurrency_enabled',
			  'multicurrency_allowed_merchant_choose_currency','admin_continues_alert_interval','website_twentyfour_format'
		));				
