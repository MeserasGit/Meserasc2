	      ...
	      <div class="align-self-center w-100" >	      
	       <div class="d-flex justify-content-start mb-2">
			...
			<?php foreach ($data['cuisine'] as $cuisine_key=> $item_cuisine):?>				 
				 <span class="badge badge-white mr-1"><?php echo $item_cuisine;?></span>
				 <?php 				 
				 if($cuisine_key>0){
					 break;
				 }
	       ...
	       <div class="d-flex justify-content-start mb-3">
	        ...
	        <div class="w-50 align-self-center"><p class="m-0"><?php echo Price_Formatter::$number_format['currency_symbol'];?> - <?php echo t("low cost restaurant")?></p></div>
...
<!-- <div class="container">
<div class="row">
    <div class="col-lg-9 col-md-12 mb-3 mb-lg-3 border">
        1
    </div>
</div
</div> -->
